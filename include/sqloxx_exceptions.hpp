...
#ifndef sqloxx_exceptions_hpp_9692350262303472389
#define sqloxx_exceptions_hpp_9692350262303472389
 ...
 * of each exception class provided here is facilitated by the macro
 * JEWEL_DERIVED_EXCEPTION, also defined in <jewel/exception.hpp>.
 * Briefly, a statement of the form
 * "JEWEL_DERIVED_EXCEPTION(D, B)" declares and defines an exception
 * class D that publically inherits from the class B.
 *
...
JEWEL_DERIVED_EXCEPTION(SQLiteNotFound, SQLiteException);
JEWEL_DERIVED_EXCEPTION(SQLiteFull, SQLiteException);
JEWEL_DERIVED_EXCEPTION(SQLiteCantOpen, SQLiteException);
JEWEL_DERIVED_EXCEPTION(SQLiteProtocol, SQLiteException);
...
#endif  // sqloxx_exceptions_hpp_9692350262303472389
